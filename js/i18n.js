...
(function () {
  ...
  const translations = {
    ...
    tr: {
      ...
      'portfolio.project3.desc':        'Dimes için hazırlanan modern web tasarım yenileme konseptidir. Not: Bu çalışma sadece bir tasarım fikridir, markanın resmi güncel web sitesi değildir.',
    ...
    en: {
      ...
      'portfolio.project3.desc':        'Ein modernes Webdesign-Redesign-Konzept für Dimes. Hinweis: Diese Arbeit ist rein ein Designkonzept und nicht die offizielle aktuelle Website der Marke.',
      ...
      'portfolio.project3.desc':        'A modern web design redesign concept prepared for Dimes. Note: This work is purely a design concept and is not the official current website of the brand.',
    ...
    ar: {
      ...
      'portfolio.project3.desc':        'مفهوم حديث لإعادة تصميم موقع الويب لشركة Dimes. ملاحظة: هذا العمل هو مجرد مفهوم تصميمي وليس موقع الويب الرسمي الحالي للعلامة التجارية.',
