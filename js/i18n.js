...
(function () {
  ...
  const translations = {
    ...
    en: {
      ...
      'pricing.type.landing':       'Landing Page',
      'pricing.type.landing.price': 'Starting from ₺4,500',
      'pricing.type.corporate':       'Corporate Site',
      'pricing.type.corporate.price': 'Starting from ₺6,000',
      'pricing.type.ecommerce':       'E-Commerce',
      'pricing.type.ecommerce.price': 'Starting from ₺8,000',
      'pricing.addon.seo':          'Advanced SEO Package (+₺750)',
      'pricing.addon.seo.desc':     'Keyword research and technical sitemaps.',
      'pricing.addon.multilang':    'Multilingual Support (+₺1,000)',
      'pricing.addon.multilang.desc': 'Infrastructure setup for English or other languages.',
      'pricing.addon.whatsapp':     'Quick WhatsApp Integration (+₺500)',
      'pricing.addon.whatsapp.desc': 'Button for customers to contact you directly via WhatsApp.',
      'pricing.addon.speed':        'Extra Speed Optimization (+₺800)',
    ...
    de: {
      ...
      'pricing.type.landing':       'Landing Page',
      'pricing.type.landing.price': 'Ab ₺4.500',
      'pricing.type.corporate':       'Unternehmensseite',
      'pricing.type.corporate.price': 'Ab ₺6.000',
      'pricing.type.ecommerce':       'E-Commerce',
      'pricing.type.ecommerce.price': 'Ab ₺8.000',
      'pricing.addon.seo':          'Erweitertes SEO-Paket (+₺750)',
      'pricing.addon.seo.desc':     'Keyword-Recherche und technische Sitemaps.',
      'pricing.addon.multilang':    'Mehrsprachige Unterstützung (+₺1.000)',
      'pricing.addon.multilang.desc': 'Infrastruktureinrichtung für andere Sprachen.',
      'pricing.addon.whatsapp':     'Schnelle WhatsApp-Integration (+₺500)',
      'pricing.addon.whatsapp.desc': 'Schaltfläche für direkten WhatsApp-Kontakt.',
      'pricing.addon.speed':        'Zusätzliche Geschwindigkeitsopt. (+₺800)',
  ...
  function init() {
    ...
    else if (SUPPORTED.includes(stored)) lang = stored;
