...
(function () {
  ...
  const translations = {
    ...
    tr: {
      ...
      'portfolio.project3.badge':       'Konsept & Lab',
      'portfolio.project3.title':       'Dimes',
      'portfolio.project3.cat':         'Kreatif Arayüz / Web Sitesi Yenileme Konsepti',
      'portfolio.project3.desc':        'Ünlü içecek markası Dimes için hazırlanan modern web tasarım yenileme konseptidir.',
      'portfolio.project3.note':        'Not: Bu çalışma sadece bir tasarım fikridir, markanın resmi güncel web sitesi değildir.',
      'portfolio.project3.stat1.num':   'Özel',
      'portfolio.project3.stat1.label': 'Marka Tasarımı',
      'portfolio.project3.stat2.num':   'Kreatif',
      'portfolio.project3.stat2.label': 'Menü Tasarımı',
      ...
      'toast.err.recaptcha': 'Lütfen robot olmadığınızı doğrulayın.',
    ...
    en: {
      ...
      'portfolio.project3.badge':       'Konzept & Labor',
      'portfolio.project3.title':       'Dimes',
      'portfolio.project3.cat':         'Kreatives UI / Website-Redesign-Konzept',
      'portfolio.project3.desc':        'Ein modernes Webdesign-Redesign-Konzept für die berühmte Getränkemarke Dimes.',
      'portfolio.project3.note':        'Hinweis: Diese Arbeit ist rein ein Designkonzept und nicht die offizielle aktuelle Website der Marke.',
      'portfolio.project3.stat1.num':   'Individuell',
      'portfolio.project3.stat1.label': 'Markendesign',
      'portfolio.project3.stat2.num':   'Kreativ',
      'portfolio.project3.stat2.label': 'Menü-Design',

      'portfolio.project3.badge':       'Concept & Lab',
      'portfolio.project3.title':       'Dimes',
      'portfolio.project3.cat':         'Creative UI / Website Redesign Concept',
      'portfolio.project3.desc':        'A modern web design redesign concept prepared for the famous beverage brand Dimes.',
      'portfolio.project3.note':        'Note: This work is purely a design concept and is not the official current website of the brand.',
      'portfolio.project3.stat1.num':   'Custom',
      'portfolio.project3.stat1.label': 'Brand Design',
      'portfolio.project3.stat2.num':   'Creative',
      'portfolio.project3.stat2.label': 'Menu Design',
      ...
      'toast.err.recaptcha': 'Please verify that you are not a robot.',
    ...
    de: {
      ...
      'toast.err.recaptcha': 'Bitte bestätigen Sie, dass Sie kein Roboter sind.',
    ...
    ar: {
      ...
      'portfolio.project3.badge':       'مفهوم ومختبر',
      'portfolio.project3.title':       'Dimes',
      'portfolio.project3.cat':         'واجهة إبداعية / مفهوم إعادة تصميم موقع الويب',
      'portfolio.project3.desc':        'مفهوم حديث لإعادة تصميم موقع الويب لشركة المشروبات الشهيرة Dimes.',
      'portfolio.project3.note':        'ملاحظة: هذا العمل هو مجرد مفهوم تصميمي وليس موقع الويب الرسمي الحالي للعلامة التجارية.',
      'portfolio.project3.stat1.num':   'مخصص',
      'portfolio.project3.stat1.label': 'تصميم الهوية',
      'portfolio.project3.stat2.num':   'إبداعي',
      'portfolio.project3.stat2.label': 'تصميم القائمة',
      ...
      'faq.4.a': 'بالتأكيد. عندما نسلم موقعك، نقوم بدمج لوحة إدارة سهلة الاستخدام للغاية. من خلال هذه اللوحة، يمكنك تحديث المحتوى والمنتجات والصور والنصوص في أي وقت دون أي معرفة برمجية. كما نقدم دعماً فنياً لمدة شهر بعد التسليم.',
      'faq.5.q': 'هل سأظهر في محركات البحث (Google)؟',
      'faq.5.a': 'نقوم ببرمجة بنية موقع الويب الخاص بك لتكون متوافقة تماماً مع معايير Google ومحسنة لمحركات البحث (SEO). يتم إنشاء خريطة موقعك وتسجيلك في Google Search Console مجاناً. بهذه الطريقة، يتم فهرسة موقعك بسرعة بواسطة محركات البحث ويصبح قابلاً للاكتشاف.',
      ...
      'toast.err.recaptcha': 'يرجى التحقق من أنك لست روبوتًا.',
      ...
      'contact.subtitle':    'اتصل بنا لإخبارنا عن مشروعك وتأخذ مكانك في العالم الرقمي على الفور.',
      'contact.form.title':  'نموذج عرض السعر السريع',
      'contact.form.name':       'الاسم الكامل *',
      'contact.form.name.ph':    'مثال: أحمد محمد',
      'contact.form.phone':      'رقم الهاتف *',
      'contact.form.phone.ph':   'مثال: +90 555 123 45 67',
      'contact.form.email':      'البريد الإلكتروني',
      'contact.form.email.ph':   'مثال: ahmed@sirketiniz.com',
      'contact.form.service':    'الخدمة المطلوبة',
      'contact.form.opt.landing':  'صفحة هبوط / موقع من صفحة واحدة',
      ...
      'contact.form.message':    'الرسالة / تفاصيل المشروع *',
      ...
      'contact.card.tagline':'يمكنك الاتصال بنا في أي وقت عبر إنستغرام أو الهاتف أو واتساب أو البريد الإلكتروني لمشروعك.',
      'contact.instagram':   'تابعنا على إنستغرام',
      'contact.divider':     'أو اتصل مباشرة',
